...
@section('main-content')
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- form start -->
            <form role="form" action="{{ route('post.update', $model->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor1" rows="10" cols="80" name="description">{{ $model->description }}</textarea>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="is_published" @if($model->is_published == 1) checked @endif value="{{$model->is_published}}"> Publish
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select a State" style="width: 100%;" tabindex="-1" aria-hidden="true" name="categories[]">
                                    @foreach($categories as $category)
                                        ...
                                        @foreach($model->categories as $selected)
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select a State" style="width: 100%;" tabindex="-1" aria-hidden="true" name="tags[]">
                                    @foreach($tags as $tag)
                                        <option value="{{ $tag->id }}"
                                        @foreach($model->tags as $selected)
